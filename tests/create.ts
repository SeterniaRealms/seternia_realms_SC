...
describe("seternia", () => {
  ...
  const symbol: String = "STR"
  const Swordsman = "https://aquamarine-elaborate-cuckoo-625.mypinata.cloud/ipfs/QmVwUWZQGqgNWqabyQoN8hBBfMpJJk5Na3u5qzCidBTR4g";
